      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-64 flex-shrink-0">
          <div className="bg-card rounded-2xl border border-border/50 shadow-sm overflow-hidden">
            {/* Avatar section */}
            <div className="bg-gradient-to-br from-duwaz-brown/15 to-duwaz-brown/5 dark:from-duwaz-brown/20 dark:to-transparent pt-8 pb-5 px-5 text-center border-b border-border/40">
              <div className="relative inline-block">
                <Avatar className="h-20 w-20 ring-4 ring-white shadow-md">
                  ...
                  <AvatarFallback className="text-xl bg-duwaz-brown text-white font-semibold">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 bg-duwaz-brown text-white rounded-full p-1.5 shadow-md hover:bg-duwaz-brown/80 transition-colors"
                  aria-label="Change profile picture"
                >
                  <Camera className="h-3 w-3" />
                </button>
              </div>
              <h2 className="font-semibold text-base text-foreground mt-3 leading-tight">
                {studentLoading ? '…' : (student?.studentName ?? 'Student')}
              </h2>
              <p className="text-xs text-muted-foreground mt-0.5">{student?.studentNumber ?? ''}</p>
            </div>
            ...
            <div className="p-5 space-y-3 text-sm">
              ...
              {student?.locationAddress && (
                <div className="pt-3 border-t border-border/40">
                  ...
                  <p className="text-xs font-medium text-foreground leading-relaxed">{student.locationAddress}</p>
                </div>
              )}
            </div>
          </div>
